  ...
  return (
    <svg className="misha-logo-mark" viewBox="0 0 220 72" role="img" aria-label="MISHA Systems">
      ...
      <g fill="currentColor" fontFamily="Arial,Helvetica,sans-serif">
        <text x="76" y="31" fontSize="20" fontWeight="800" letterSpacing="3.1">MISHA</text>
        <text x="89" y="48" fontSize="9" fontWeight="700" letterSpacing="3">SYSTEMS</text>
        <line x1="89" y1="55" x2="121" y2="55" stroke="currentColor" strokeWidth="1"/>
        <line x1="151" y1="55" x2="183" y2="55" stroke="currentColor" strokeWidth="1"/>
      </g>
    </svg>
  );
}
